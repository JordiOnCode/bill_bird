...
class _LoginWidgetState extends State<LoginWidget> {
  ...
  void initState() {
    ...
    _model.passwordCreaterRepeateController ??= TextEditingController();
  }
                              ...
                              child: Column(
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: TextFormField(
                                      controller:
                                          _model.emailAddress1Controller,
                                      obscureText: false,
                                    ...
                                    child: Autocomplete<String>(
                                      ...
                                      optionsViewBuilder:
                                        ...
                                        return AutocompleteOptionsList(
                                          textFieldKey: _model.password1Key,
                                          textController:
                                      ...
                                      onSelected: (String selection) {
                                        setState(() =>
                                            _model.password1SelectedOption =
                                                selection);
                                  ...
                                  Padding(
                                    ...
                                    child: Autocomplete<String>(
                                      ...
                                      optionsViewBuilder:
                                        ...
                                        return AutocompleteOptionsList(
                                          textFieldKey:
                                              _model.passwordCreaterRepeateKey,
                                          textController: _model
                                              .passwordCreaterRepeateController!,
                                          options: options.toList(),
                                          onSelected: onSelected,
                                          textStyle:
                                              FlutterFlowTheme.of(context)
                                      ...
                                      onSelected: (String selection) {
                                        setState(() => _model
                                                .passwordCreaterRepeateSelectedOption =
                                            selection);
                                        FocusScope.of(context).unfocus();
                                      },
                                      fieldViewBuilder: (
                                        ...
                                        _model.passwordCreaterRepeateController =
                                            textEditingController;
                                        return TextFormField(
                                          key: _model.passwordCreaterRepeateKey,
                                          controller: textEditingController,
                                          focusNode: focusNode,
                                          onEditingComplete: onEditingComplete,
                                          obscureText: !_model
                                              .passwordCreaterRepeateVisibility,
                                          decoration: InputDecoration(
                                            labelText: 'Password',
                                            labelStyle:
                                                FlutterFlowTheme.of(context)
                                            ...
                                            suffixIcon: InkWell(
                                              ...
                                              focusNode: FocusNode(
                                                  skipTraversal: true),
                                              child: Icon(
                                                _model.passwordCreaterRepeateVisibility
                                                    ? Icons.visibility_outlined
                                                    : Icons
                                                        .visibility_off_outlined,
                                                color:
